...
Instalación:
Copiar y descomprimir el archivo en la carpeta de proyectos de su servidor web. Al final tendrás una carpeta llamada "Firme Como Rulo", a la cual accederás desde el navegador como http://localhost/Firme%20como%20Rulo/.
...
Paso 1: Dirígete a la página http://localhost/Firme%20como%20Rulo/.
...
Si es necesario, modifica el archivo http://localhost/Firme%20como%20Rulo/conexion.php para actualizar los datos asociados al acceso a la base de datos, como el servidor, el usuario, la contraseña y el nombre de la base de datos.
