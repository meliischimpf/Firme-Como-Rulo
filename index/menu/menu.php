  ...
  <div class="container">
    <div class="sidebar">
     ...
     <div class="side-wrapper">
      ...
      <div class="side-menu">
       <a class="sidebar-link" href="../menu/registrar/registrar_alumno.php">
        <svg viewBox="0 0 24 24" fill="currentColor">
       ...
       <a class="sidebar-link" href="../menu/registrar/registrar_materia.php">
        <svg viewBox="0 0 24 24" fill="currentColor">
       ...
       <a class="sidebar-link" href="../menu/registrar/registrar_instituto.php">
        <svg viewBox="0 0 24 24" fill="currentColor">
